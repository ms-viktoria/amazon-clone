...
document
  .querySelector(".js-reset-confirmation")
...
function showResetConfirmation() {
  ...
  <button class="js-reset-confirm-yes reset-confim-button">Yes</button>
  <button class="js-reset-confirm-no reset-confim-button">No</button>`;
